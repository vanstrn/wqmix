...
from utils.rl_utils import build_td_lambda_targets_liir
import torch as th
...
class LIIRLearner:
    ...
    def _train_critic(self, batch, rewards, terminated, actions, avail_actions, mask, bs, max_t):
        ...
        targets_mix, targets_ex = build_td_lambda_targets_liir(rewards, terminated, mask, target_vals, self.n_agents,
